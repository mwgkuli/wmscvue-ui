...
(function () {
    ...
    var top_ad = [
     	{ srcsmall: u + "images/top/top2019/wanmei_gg_small_20190404.jpg?v=1", srcbig: u + "images/top/top2019/wanmei_gg_big_20190404.jpg?v=1", href: "http://sg.wanmei.com/" },
		// { srcsmall: u + "images/top/top2017/wanmei_gg_small_20171024.jpg?v=1", srcbig: u + "images/top/top2017/wanmei_gg_big_20171024.jpg?v=1", href: "http://zhuxian.wanmei.com/" }
//      { srcsmall: u + "images/top/top2017/wanmei_gg_small_20170904.jpg?v=1", srcbig: u + "images/top/top2017/wanmei_gg_big_20170904.jpg?v=1", href: "http://xa.wanmei.com/" },
//      { srcsmall: u + "images/top/top2017/wanmei_gg_small_20170904.jpg?v=1", srcbig: u + "images/top/top2017/wanmei_gg_big_20170904.jpg?v=1", href: "http://xa.wanmei.com/" }
    ];
    var Global = {
        'top': [
            ...
            { name: 'wanmei', skin: 1, pay: py, bbs: 'http://bbs.wanmei.com', ad: 1 },
		    { name: 'sg',acc: true, skin: 4, pay: pay('newpay.do?op=prepay&gametype=5'), bbs: bbs('sg'), ad: 1},
		    { name: 'chibi',acc: true, skin: 4, pay: pay('newpay.do?op=prepay&gametype=5'), bbs: bbs('sg'), ad: 1},
		    { name: 'sgcq',acc: true, skin: 1, pay: pay('newpay.do?op=prepay&gametype=11'), bbs: bbs('sgcq'), ad: 1 },
		    { name: 'w2i',acc: true, skin: 2, pay: pay('newpay.do?op=prepay&gametype=3'), bbs: bbs('w2i'), ad: 1 },
		    { name: 'world2',acc: true, skin: 1, pay: pay('newpay.do?op=prepay&gametype=1'), bbs: bbs('world2'), ad: 1 },
		    { name: 'wulin2',acc: true, skin: 3, pay: pay('newpay.do?op=prepay&gametype=2'), bbs: bbs('wulin2'), ad: 1 },
            { name: 'wulin',acc: true, skin: 3, pay: pay('newpay.do?op=prepay&gametype=2'), bbs: bbs('wulin'), ad: 1 },
		    { name: 'kdxy',acc: true, skin: 1, pay: pay('newpay.do?op=prepay&gametype=7'), bbs: bbs('kdxy'), ad: 1 },
		    { name: 'zhuxian',acc: true, skin: 3, pay: pay('newpay.do?op=prepay&gametype=4'), bbs: bbs('zhuxian'), ad: 1 },
		    ...
		    { name: 'rwpd',acc: true, skin: 1, pay: pay('newpay.do?op=prepay&gametype=6'), bbs: bbs('rwpd'), ad: 1 },
		    { name: 'mhzx', skin: 1, pay: pay(''), bbs: bbs('xmhzx'), ad: 1 },
		    { name: 'shenmo',acc: true, skin: 2, pay: pay('newpay.do?op=prepay&gametype=12'), bbs: bbs('shenmo'), ad: 1 },
		    { name: 'sm', skin: 2, pay: pay('newpay.do?op=prepay&gametype=12'), bbs: bbs('shenmo'), ad: 1 },
		    { name: 'xlzj', skin: 2, pay: pay(''), bbs: bbs('xlzj'), ad: 1 },
		    { name: 'sgsj',acc: true, skin: 4, pay: pay('newpay.do?op=prepay&gametype=18'), bbs: bbs('sgsj'), ad: 1 },
		    { name: 'qd', skin: 1, pay: py, bbs: bs, ad: 1 },
		    { name: 'xa',acc: true, skin: 2, pay: pay('newpay.do?op=prepay&gametype=16'), bbs: bbs('xa'), ad: 1 },
		    ...
		    { name: 'sdxl',acc: true, skin: 1, pay: pay('newpay.do?op=prepay&gametype=19'), bbs: bs, ad: 1 },
		    { name: 'mhzx2',acc: true, skin: 1, pay: pay('newpay.do?op=prepay&gametype=8'), bbs: bbs('mhzx2'), ad: 1 },
			...
			{ name: 't', acc: true, skin: 1, pay:'http://yeyou.wanmei.com/billing/charge?gameId=36&serverNo=all', bbs: false, ad: 1 }
        ],
        'bottom': [
		{ name: 'wanmei', skin: 1 },
		{ name: 'sg', skin: 4 },
    ...
    var bottom_data2 = [
		...
		{ name: '%u9690%u79C1%u653F%u7B56', href: 'http://static.wanmei.com/passport/agreement/005.html' },
    ...
    var bottom_css = {
        bottom: 'position:absolute;z-index:98;height:132px; ',
        bg: 'position:absolute;z-index:99;height:132px;',
        main: 'position:absolute;z-index:100;height:132px;',
        warp: 'position:relative;z-index:101;width:850px;height:105px;padding-top:15px;margin:0px auto;',
        ...
        icp: 'position:absolute;z-index:103;height:20px;left:245px;top:52px;font-size:12px;',
        icp2: 'position:absolute;z-index:103;height:20px;left:245px;top:72px;font-size:12px;',
        copyright: 'position:absolute;z-index:103;height:20px;left:245px;top:92px;font-size:12px;',
        copyright2: 'position:absolute;z-index:103;height:20px;left:245px;top:112px;font-size:12px;',
        ...
        beian_hex2: 'left:100px;background:url(http://hex.wanmei.com/images/none.gif) no-repeat left top;line-height:14px;',
        beian_hex1: ';background:url(' + u + 'images/top/bg.gif) no-repeat -78px -211px;line-height:14px;'
        ...
        var wm = window.wm = {
            ...
            top: function (obj, elm, fn) {
                ...
                if (this.istop === 1) {
                    ...
                    t.innerHTML = '<div class="wanmei_top" style="position: absolute; top: 0; left: 0;"><div class="wanmei_nav" id="wanmei_nav" style=' + top_css.wanmei_top + '>' + creTop(pa) + '</div>' + '</div>';
                    var b = wm.tag('body')[0];
                ...
                if (elm) {
                    ...
                    if (typeof elm == 'object') {
                        this.istop = false;
                        elm.innerHTML = '<div class="wanmei_top" style=" " id="wanmei_top"><div class="wanmei_top" style="position: absolute; top: 0; left: 0;"></div><div class="wanmei_nav" id="wanmei_nav" style=' + top_css.wanmei_top + '>' + creTop(pa) + '</div></div>';
                        bind();
                        bindAD();
                        initVar();
                        //playBanner();
                ...
                this.istop = false;
                document.write('<div class="wanmei_top" style=" " id="wanmei_top"><div class="wanmei_top" style="position: absolute; top: 0; left: 0;"></div><div class="wanmei_nav" id="wanmei_nav" style=' + top_css.wanmei_top + '>' + creTop(pa) + '</div></div>');
                bind();
                bindAD();
                initVar();
                //playBanner();
            ...
            bottom: function (obj, elm) {
                ...
                if (elm) {
                    ...
                    if (typeof elm == 'object') {
                        this.isbottom = false;
                        elm.innerHTML = '<div id="wm_bottom_" style="' + bottom_css.bottom + '">' + creBottom(pa.name) + '</div>';
                        return;
                    } else {
                    }
                }
                this.isbottom = false;
                document.write('<div id="wm_bottom_" style="' + bottom_css.bottom + '">' + creBottom(pa.name) + '</div>');
            },
            delLogo: function () { },
    ...
    function creBottom(bottomTypeValue) {
    	// console.log('bottomTypeValue', bottomTypeValue)
    	var str=""
    	bottomTypeValue = bottomTypeValue? bottomTypeValue : '';
    	if (bottomTypeValue == 'hex') {
    		str += '<link type="text/css" rel="stylesheet" href="http://static.games.wanmei.com/public/style/bottom/201612_hex.css">';
    		str += '<div id="hex_footer">';
    		str += '	<div class="sm_footer_main">';
    		str += '		<div class="sm_footer_left"><a href="http://www.wanmei.com/" target="_blank" class="hex_bottom_logo">' + unescape("%u5B8C%u7F8E%u4E16%u754C") + '</a></div>';
    		str += '		<div class="sm_footer_center">';
    		str += '			<p>' + creBottomlist2(bottom_data) + '</p>';
    		str += '			<p class="ps">' + unescape("%u6210%u90FD%u5B8C%u7F8E%u65F6%u7A7A%u7F51%u7EDC%u6280%u672F%u6709%u9650%u516C%u53F8%20%u7248%u6743%u6240%u6709") + '</p>';
    		str += '			<p>ISBN 978-7-89988-441-6</p>';
    		str += '			<p>Copyright© 2004-2017Perfect World Co.,Ltd. All rights reserved.</p>';
    		str += '			<p class="ps">' + unescape("%7C%20%u4EACICP%u8BC1050016%u53F7%20%7C%20%u6587%u7F51%u6587%5B2017%5D8929-1007%u53F7%20%7C%20%u65B0%u51FA%u5BA1%u5B57%5B2013%5D917%u53F7%20%7C%20ISBN%u53F7%uFF1A978-7-89989-730-0%20%7C") + '</p>';
    		str += '		</div>';
    		str += '		<div class="sm_footer_right"><a href="http://www.hd315.gov.cn/beian/view.asp?bianhao=010202005060700536" target="_blank"><span></span> <em>' + unescape('%u7ECF%u8425%u6027%u7F51%u7AD9') + '</em> <em>' + unescape('%u5907%u6848%u4FE1%u606F') + '</em></a></div>';
    		str += '	</div>';
    		str += '</div>';
    	}else{
    		str = '<div class="wm_bottom_bg" id="wm_bottom_bg" style="' + bottom_css.bg + '"></div>';
	        ...
	        str += '<div style="' + bottom_css.items2 + '" class="wm_bottom_items">' + creBottomlist(bottom_data2) + '</div>';
	        str += '<div style="' + bottom_css.icp + '" class="wm_bottom_icp">'+unescape("%u4EACICP%u8BC1%uFF1A050016%u53F7%u3000")+'<a href="http://www.wanmei.com/permit/culture.html" target="_blank">' + unescape('%u300A%u7F51%u7EDC%u6587%u5316%u7ECF%u8425%u8BB8%u53EF%u8BC1%u300B%u7F16%u53F7%uFF1A%u4EAC%u7F51%u6587%5B2017%5D8929-1007%u53F7') + '</a></div>';
	        ...
	        switch (bottomTypeValue) {
	        	case 'w2i':
	        	str+='<div style="' + bottom_css.copyright + '" class="wm_bottom_copyright"><a href="http://sq.ccm.gov.cn/ccnt/sczr/service/business/emark/gameNetTag/2520" target="_blank"><img src="http://static.games.wanmei.com/public/images/bottom/icon.png" style="float: left;width: 16px;margin-right: 5px;">'+unescape("%u6587%u7F51%u5907%u5B57%uFF082007%uFF0911%u53F7")+'</a>' + unescape("%26emsp%3B%26emsp%3B%26emsp%3B%26emsp%3BISBN%20978-7-89989-048-6") + '</div>';
	        	break;

	        	case 'world2':
	        	str+='<div style="' + bottom_css.copyright + '" class="wm_bottom_copyright"><a href="http://sq.ccm.gov.cn/ccnt/sczr/service/business/emark/gameNetTag/2530" target="_blank"><img src="http://static.games.wanmei.com/public/images/bottom/icon.png" style="float: left;width: 16px;margin-right: 5px;">'+unescape("%u6587%u7F51%u5907%u5B57%5B2006%5D023%u53F7")+'</a>' + unescape("%26emsp%3B%26emsp%3B%26emsp%3B%26emsp%3BISBN%20978-7-89989-023-3") + '</div>';
	        	break;

	        	case 'shenmo':
	        	str+='<div style="' + bottom_css.copyright + '" class="wm_bottom_copyright"><a href="http://sq.ccm.gov.cn/ccnt/sczr/service/business/emark/gameNetTag/1711" target="_blank"><img src="http://static.games.wanmei.com/public/images/bottom/icon.png" style="float: left;width: 16px;margin-right: 5px;">'+unescape("%u6587%u7F51%u6E38%u5907%u5B57%5B2011%5DC-RPG148%u53F7")+'</a>' + unescape("%26emsp%3B%26emsp%3B%26emsp%3B%26emsp%3BISBN%20987-7-89989-065-3") + '</div>';
	        	break;

	        	case 'xa':
	        	str+='<div style="' + bottom_css.copyright + '" class="wm_bottom_copyright"><a href="http://sq.ccm.gov.cn/ccnt/sczr/service/business/emark/gameNetTag/102" target="_blank"><img src="http://static.games.wanmei.com/public/images/bottom/icon.png" style="float: left;width: 16px;margin-right: 5px;">'+unescape("%u6587%u7F51%u6E38%u5907%u5B57%5B2013%5DC-RPG074%u53F7")+'</a>' + unescape("%26emsp%3B%26emsp%3B%26emsp%3B%26emsp%3BISBN%20978-7-89989-252-7") + '</div>';
	        	break;

	        	case 'sg': 
	        	str+='<div style="' + bottom_css.copyright + '" class="wm_bottom_copyright"><a href="http://sq.ccm.gov.cn:80/ccnt/sczr/service/business/emark/gameNetTag/4028c08b51af781b0151d817de545530" target="_blank"><img src="http://static.games.wanmei.com/public/images/bottom/icon.png" style="float: left;width: 16px;margin-right: 5px;">'+unescape("%u6587%u7F51%u6E38%u5907%u5B57%u30142015%u3015%uFF23-RPG%201198%u53F7")+'</a>' + unescape("%26emsp%3B%26emsp%3B%26emsp%3B%26emsp%3BISBN%20978-7-89988-052-3") + '</div>';
	        	break;

	        	case 'wulin2':
	        	str+='<div style="' + bottom_css.copyright + '" class="wm_bottom_copyright"><a href="http://sq.ccm.gov.cn/ccnt/sczr/service/business/emark/gameNetTag/2519" target="_blank"><img src="http://static.games.wanmei.com/public/images/bottom/icon.png" style="float: left;width: 16px;margin-right: 5px;">'+unescape("%u6587%u7F51%u5907%u5B57%5B2007%5D10%u53F7")+'</a>' + unescape("%26emsp%3B%26emsp%3B%26emsp%3B%26emsp%3BISBN%20978-7-89989-062-2") + '</div>';
	        	break;


	        	case 'mhzx2':
	        	str+='<div style="' + bottom_css.copyright + '" class="wm_bottom_copyright"><a href="http://sq.ccm.gov.cn/ccnt/sczr/service/business/emark/gameNetTag/4028c08c51af8c940151d2114c0a47a3" target="_blank"><img src="http://static.games.wanmei.com/public/images/bottom/icon.png" style="float: left;width: 16px;margin-right: 5px;">'+unescape("%u6587%u7F51%u6E38%u5907%u5B57%u30142015%u3015%uFF23-RPG%201175%u53F7")+'</a>' + unescape("%26emsp%3B%26emsp%3B%26emsp%3B%26emsp%3BISBN%20978-7-89989-025-7") + '</div>';
	        	break;

	        	case 'zhuxian':
	        	str+='<div style="' + bottom_css.copyright + '" class="wm_bottom_copyright"><a href="http://sq.ccm.gov.cn/ccnt/sczr/service/business/emark/gameNetTag/2495" target="_blank"><img src="http://static.games.wanmei.com/public/images/bottom/icon.png" style="float: left;width: 16px;margin-right: 5px;">'+unescape("%u6587%u7F51%u5907%u5B57%5B2008%5D007%u53F7")+'</a>' + unescape("%26emsp%3B%26emsp%3B%26emsp%3B%26emsp%3BISBN%20978-7-89989-022-6") + '</div>';
	        	break;

	        	case 'shushan':
	        	str+='<div style="' + bottom_css.copyright + '" class="wm_bottom_copyright"><a href="http://sq.ccm.gov.cn/ccnt/sczr/service/business/emark/gameNetTag/4028c08c577024b80157705bce610554" target="_blank"><img src="http://static.games.wanmei.com/public/images/bottom/icon.png" style="float: left;width: 16px;margin-right: 5px;">'+unescape("%u6587%u7F51%u6E38%u5907%u5B57%u30142017%u3015%uFF23-RPG%200066%u53F7")+'</a>' + unescape("%26emsp%3B%26emsp%3B%26emsp%3B%26emsp%3BISBN%20978-7-89988-679-3") + '</div>';
	        	break;

	        	case 'sdxl':
	        	str+='<div style="' + bottom_css.copyright + '" class="wm_bottom_copyright"><a href="http://sq.ccm.gov.cn/ccnt/sczr/service/business/emark/gameNetTag/4028c08c51af8c940151d2dc1d6d4c0d" target="_blank"><img src="http://static.games.wanmei.com/public/images/bottom/icon.png" style="float: left;width: 16px;margin-right: 5px;">'+unescape("%u6587%u7F51%u6E38%u5907%u5B57%u30142015%u3015%uFF23-RPG%201167%u53F7")+'</a>' + unescape("%26emsp%3B%26emsp%3B%26emsp%3B%26emsp%3BISBN%20978-7-89989-384-5") + '</div>';
	        	break;

	        	case 'seiya':
	        	str+='<div style="' + bottom_css.copyright + '" class="wm_bottom_copyright"><a href="http://sq.ccm.gov.cn/ccnt/sczr/service/business/emark/gameNetTag/101" target="_blank"><img src="http://static.games.wanmei.com/public/images/bottom/icon.png" style="float: left;width: 16px;margin-right: 5px;">'+unescape("%u6587%u7F51%u6E38%u5907%u5B57%5B2013%5DC-RPG075%u53F7")+'</a>' + unescape("%26emsp%3B%26emsp%3B%26emsp%3B%26emsp%3BISBN%20978-7-89989-595-5") + '</div>';
	        	break;

	        	case 'rwpd':
	        	str+='<div style="' + bottom_css.copyright + '" class="wm_bottom_copyright"><a href="http://sq.ccm.gov.cn/ccnt/sczr/service/business/emark/gameNetTag/2486" target="_blank"><img src="http://static.games.wanmei.com/public/images/bottom/icon.png" style="float: left;width: 16px;margin-right: 5px;">'+unescape("%u6587%u7F51%u5907%u5B57%5B2009%5D001%u53F7")+'</a>' + unescape("%26emsp%3B%26emsp%3B%26emsp%3B%26emsp%3BISBN%20978-7-89989-104-9") + '</div>';
	        	break;


	        	case 'kdxy':
	        	str+='<div style="' + bottom_css.copyright + '" class="wm_bottom_copyright"><a href="http://sq.ccm.gov.cn/ccnt/sczr/service/business/emark/gameNetTag/2375" target="_blank"><img src="http://static.games.wanmei.com/public/images/bottom/icon.png" style="float: left;width: 16px;margin-right: 5px;">'+unescape("%u6587%u7F51%u6E38%u5907%u5B57%5B2010%5DC-RPG003%u53F7")+'</a>' + unescape("%26emsp%3B%26emsp%3B%26emsp%3B%26emsp%3BISBN%20978-7-89989-022-6") + '</div>';
	        	break;
	        	
	        	case 'co':
	        	str+='<div style="' + bottom_css.copyright + '" class="wm_bottom_copyright"><a href="http://sq.ccm.gov.cn/ccnt/sczr/service/business/emark/gameNetTag/4028c08c5a4b89a9015a7e4ee8fd1001" target="_blank"><img src="http://static.games.wanmei.com/public/images/bottom/icon.png" style="float: left;width: 16px;margin-right: 5px;">' + unescape("%u6587%u7F51%u6E38%u8FDB%u5B57%u30142017%u30150091%u53F7%u2003") + '</a></div>';
	        	break;
	        	
	        	case 'sgcq':
	        	str+='<div style="' + bottom_css.copyright + '" class="wm_bottom_copyright"><a href="http://sq.ccm.gov.cn/ccnt/sczr/service/business/emark/gameNetTag/2377" target="_blank"><img src="http://static.games.wanmei.com/public/images/bottom/icon.png" style="float: left;width: 16px;margin-right: 5px;">'+unescape("%u6587%u7F51%u6E38%u5907%u5B57%5B2010%5DC-RPG004%u53F7")+'</a>' + unescape("%26emsp%3B%26emsp%3B%26emsp%3B%26emsp%3BISBN%207-89992-531-7") + '</div>';
	        	break;
	        	case 'sgsj':
	        	str+='<div style="' + bottom_css.copyright + '" class="wm_bottom_copyright"><a href="http://sq.ccm.gov.cn/ccnt/sczr/service/business/emark/gameNetTag/1713" target="_blank"><img src="http://static.games.wanmei.com/public/images/bottom/icon.png" style="float: left;width: 16px;margin-right: 5px;">'+unescape("%u6587%u7F51%u6E38%u5907%u5B57%5B2011%5DC-RPG150%u53F7")+'</a>' + unescape("%26emsp%3B%26emsp%3B%26emsp%3B%26emsp%3BISBN%207-89992-531-7") + '</div>';
	        	break;

	        	
	        	case 'smdl':
	        	str+='<div style="' + bottom_css.copyright + '" class="wm_bottom_copyright">' + unescape("%u6587%u7F51%u6E38%u5907%u5B57%5B2011%5DC-RPG148%u53F7%26emsp%3B%26emsp%3B%26emsp%3B%26emsp%3BISBN%20978-7-89989-065-3") + '</div>';
	        	break;

	        	case 't':
	        	str+='<div style="' + bottom_css.copyright + '" class="wm_bottom_copyright"><a href="http://sq.ccm.gov.cn/ccnt/sczr/service/business/emark/gameNetTag/4028c08c51af8c940151d73cd53d5594" target="_blank"><img src="http://static.games.wanmei.com/public/images/bottom/icon.png" style="float: left;width: 16px;margin-right: 5px;">'+unescape("%u6587%u7F51%u6E38%u5907%u5B57%u30142015%u3015%uFF37-RPG%201197%u53F7")+'</a>' + unescape("%26emsp%3B%26emsp%3B%26emsp%3B%26emsp%3BISBN%20978-7-89989-572-6") + '</div>';
	        	break;
	        	
	        	case 'ytxmz':
	        	str+='<div style="' + bottom_css.copyright + '" class="wm_bottom_copyright">' + unescape("ISBN%20978-7-89988-384-6") + '</div>';
	        	break;
	        	
	        	default: 
	        	str+='<div style="' + bottom_css.copyright + '" class="wm_bottom_copyright">' + unescape("%u6587%u7F51%u5907%u5B57%5B2008%5D007%u53F7%26emsp%3B%26emsp%3B%26emsp%3B%26emsp%3BISBN%20978-7-89989-022-6") + '</div>';
	        	break;
	        }
	        str += '<div style="' + bottom_css.copyright2 + '" class="wm_bottom_copyright">' + '© '+unescape('%u5B8C%u7F8E%u4E16%u754C%20%u7248%u6743%u6240%u6709%u2003')+'Perfect World. All Rights Reserved.</div>';
    	}
    	str += '</div>'
	    str += '</div>';
        return str;
    ...
    function creTop(p) {
        ...
        var str = '<h1 class="wanmei_logo" style=' + top_css.wanmei_logo + '><a href="http://www.wanmei.com/" hidefocus="true" class="wanmei_logo_link" target="_blank">' + unescape("%u5B8C%u7F8E%u4E16%u754C") + '</a></h1>\
                        ...
                        <a href="http://bbs.wanmei.com" hidefocus="true" target="_blank" class="wanmei_msg_link03">' + unescape("%u8BBA%u575B") + '</a><span class="wanmei_msg_xian">|</span>\
						<a href="http://store.wanmei.com" hidefocus="true" target="_blank" class="wanmei_msg_link03">' + unescape("&#21830;&#22478;") + '</a> \
						 <span class="wanmei_msg_xian">|</span>\
                                    ...
                                    <ul class="wanmei_games_hot_list wanmei_clearfix">\
                                        <li>\
                                            <a href="http://zhuxian2.wanmei.com/" target="_blank" hidefocus="true" title="' + unescape("%u8BDB%u4ED93") + '">\
                                                <img src="https://static.games.wanmei.com/public/images/top/top201305/game_zhuxian.jpg" alt="' + unescape("%u8BDB%u4ED93") + '" /></a>\
                                        ...
                                        <li>\
                                            <a href="http://w2i.wanmei.com/" target="_blank" hidefocus="true" title="' + unescape("%u5B8C%u7F8E%u56FD%u9645") + '">\
                                                <img src="https://static.games.wanmei.com/public/images/top/top201305/game_w2i.jpg" alt="' + unescape("%u5B8C%u7F8E%u56FD%u9645") + '" /></a>\
                                        ...
                                        <li>\
                                            <a href="http://xa.wanmei.com/" target="_blank" hidefocus="true" title="' + unescape("%u7B11%u50B2%u6C5F%u6E56OL") + '">\
                                                <img src="https://static.games.wanmei.com/public/images/top/top201305/game_xa.jpg" alt="' + unescape("%u7B11%u50B2%u6C5F%u6E56OL") + '" /></a>\
                                            <span>' + unescape("%u7B11%u50B2%u6C5F%u6E56OL") + '</span>\
                                        </li>\
                                        <li>\
                                            <a href="http://t.wanmei.com/" target="_blank" hidefocus="true" title="' + unescape("TOUCH") + '">\
                                                <img src="https://static.games.wanmei.com/public/images/top/top201305/game_touch.jpg" alt="' + unescape("TOUCH") + '" /></a>\
                                            <span>' + unescape("TOUCH") + '</span>\
                                        </li>\
                                        <li>\
                                            <a href="http://www.dota2.com.cn/" target="_blank" hidefocus="true" title="DOTA2">\
                                                <img src="https://static.games.wanmei.com/public/images/top/top201305/game_dota2.jpg" alt="DOTA2" /></a>\
                                            <span>DOTA2</span>\
                                        </li>\
                                    </ul>\
                                </div>\
                                <div class="wanmei_game_box wanmei_clearfix">\
                                    ...
                                    <div class="wanmei_game_item wanmei_game_dj">\
                                        ...
                                        <ul class="wanmei_game_box_list">\
                                        	...
                                        	<li><a href="http://www.csgo.com.cn/" hidefocus="true" target="_blank" class="wanmei_new">CS:GO</a></li>\
                                        	<li><a href="http://co.wanmei.com" hidefocus="true" target="_blank" class="wanmei_new">' + unescape("%u521B%u4E16%u6218%u8F66") + '</a></li>\
                                        </ul>\
                                    </div>\
                                    <div class="wanmei_game_item wanmei_game_dj" style="border:0;">\
                                        <div class="wanmei_game_box_head">' + unescape("%u5355%u673A%u6E38%u620F") + '</div>\
                                        <ul class="wanmei_game_box_list">\
                                        	<li><a href="http://shmh.wanmei.com" hidefocus="true" target="_blank" class="wanmei_new">' + unescape("%u6DF1%u6D77%u8FF7%u822A") + '</a></li>\
                                        	<li><a href="http://ytxmz.wanmei.com" hidefocus="true" target="_blank">' + unescape("%u5FA1%u5929%u964D%u9B54%u4F20") + '</a></li>\
                                        	<li><a href="http://mtr.wanmei.com" hidefocus="true" target="_blank" class="wanmei_new">' + unescape("%u9762%u6761%u4eba") + '</a></li>\
                                        	<li><a href="http://ylz.wanmei.com" hidefocus="true" target="_blank" class="wanmei_new">' + unescape("%u9690%u9f99%u4f20") + '</a></li>\
                                        	<li><a href="http://hczy.wanmei.com" hidefocus="true" target="_blank" class="wanmei_new">' + unescape("%u6D2A%u6F6E%u4E4B%u7130") + '</a></li>\
                                        </ul>\
                                    </div>\
                                </div>\
                            </div>\
                            <div class="wanmei_games_r">\
								<a href="http://pgp.wanmei.com" target="_blank" class="wmpassport" title="' + unescape("%u5B8C%u7F8E%u6E38%u620F%u5E73%u53F0")+ '"><img src="https://static.games.wanmei.com/public/images/top/platform.jpg" alt="' + unescape("%u5B8C%u7F8E%u6E38%u620F%u5E73%u53F0")+ '" /></a>\
                                <ul class="wanmei_seaver wanmei_clearfix">\
                                    ...
                                    <li class="wanmei_btn08"><a href="http://passport.wanmei.com" hidefocus="true" target="_blank">' + unescape("%u4F1A%u5458%u4E2D%u5FC3") + '</a></li>\
                                </ul>\
                            </div>\
    ...
    function creatLogin(opt) {
        ...
        //var tourl = 'http://static.games.wanmei.com/public/loginRe.htm';
